...
var MIN_RATE_16p = 0.72
// mineral per worker per second
// assuming not over saturation
var MIN_RATE_MULE = 2.26
// mineral per mule per second
var GAS_RATE_2p = 0.8
...
function updateARAT()
{
    ...
    var s_ract = this._ract.sort( function( a , b )
    {
        return b[0] - a[0];
    } );
    ...
    for ( var i = 1 ; i < this.duration ; i++ )
    {
        ...
        this._arat.push(
        [ this._arat[i - 1][0] + addmin , this._arat[i - 1][1] + addgas ] );
