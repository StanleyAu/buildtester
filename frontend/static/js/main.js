...
function setCommandPanel( race )
{
    ...
    {
        var cmd_html = '<div class=\'command-action\' id=\'' + k + '\'>' + '<img src=\'../static/img/' + race + '/' + window.actions[race][k] + '.png\'>' + '</div>';
    ...
    for ( var k in window.units[race] )
    {
        ...
        var cmd_html = '<div class=\'command-unit\' id=\'' + k + '\'>' + '<img src=\'../static/img/' + race + '/' + k
        .replace( /[_-]/g , '' ) + '.png\' title=\'' + name + '\'>' + '</div>';
        units_html += cmd_html;
    }
    ...
    for ( var k in window.buildings[race] )
    {
        ...
        var cmd_html = '<div class=\'command-building\' id=\'' + k + '\'>' + '<img src=\'../static/img/' + race + '/' + k
        .replace( /[_-]/g , '' ) + '.png\' title=\'' + name + '\'>' + '</div>';
    ...
    for ( var k in window.researches[race] )
    {
        ...
        var cmd_html = '<div class=\'command-research\' id=\'' + k + '\'>' + '<img src=\'../static/img/' + race + '/' + k
        .replace( /[_-]/g , '' ) + '.png\' title=\'' + name + '\'>' + '</div>';
